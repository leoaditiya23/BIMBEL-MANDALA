...
<div x-data="{ sidebarOpen: true }" 
    ...
    <div class="flex h-full relative z-10">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full relative">
            ...
            {{-- REVISI UTAMA: Menggunakan flex-col dan min-h-full agar footer terdorong secara mekanis --}}
            <main class="flex-1 flex flex-col overflow-y-auto custom-main-scroll">
                
                <div class="flex-grow"> {{-- Div ini akan menarik sisa ruang kosong ke atas --}}
                    <div class="px-8 py-6 md:px-12 md:py-10">
                ...
                {{-- FOOTER: Sekarang dipastikan berada di dasar kontainer scroll --}}
                <footer class="py-6 px-8 md:px-12 border-t border-slate-200 bg-white text-slate-500 text-[11px] font-medium flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center space-x-6 uppercase tracking-widest">
                        <a href="{{ route('about') }}" class="hover:text-blue-600 transition-colors text-decoration-none">Tentang Kami</a>
                        <a href="{{ route('contact') }}" class="hover:text-orange-500 transition-colors text-decoration-none">Hubungi Kontak</a>
...
<style>
    ...
    /* Tambahan agar link tidak bergaris bawah jika tidak diinginkan */
