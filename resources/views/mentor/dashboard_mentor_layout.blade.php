...
<div x-data="{ sidebarOpen: true }" 
    ...
    <div class="flex h-full relative z-10">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full relative">
            ...
            {{-- REVISI: Menambahkan overflow-y-auto agar konten tetap bisa di-scroll saat di scale --}}
            <main class="flex-1 flex flex-col overflow-y-auto custom-main-scroll">
                <div class="flex-1 px-8 py-6 md:px-12 md:py-10">
                    <div class="w-full text-left">
                        @yield('mentor_content')
                    </div>
                </div>

                {{-- REVISI FOOTER: Menambahkan padding px agar simetris dengan konten di atasnya --}}
                <footer class="mt-auto py-6 px-8 md:px-12 border-t border-slate-200 bg-white/50 text-slate-500 text-[11px] font-medium flex flex-col md:flex-row justify-between items-center gap-4">
