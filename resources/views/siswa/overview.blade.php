        ...
        <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-lg transition">
            <div class="flex justify-between items-start">
                <div class="flex-1">
                    ...
                    <p class="text-3xl font-black text-blue-600">{{ $stats['attendance'] ?? 98 }}%</p>
                </div>
        ...
        <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-lg transition">
            <div class="flex justify-between items-start">
                <div class="flex-1">
                    ...
                    <p class="text-3xl font-black text-green-600">{{ $stats['average_score'] ?? 85 }}</p>
                </div>
        ...
        <div class="bg-blue-600 p-6 rounded-[2rem] shadow-lg text-white">
            <div class="flex justify-between items-start">
                <div class="flex-1">
                    ...
                    <p class="text-3xl font-black italic">#{{ $stats['class_rank'] ?? 1 }}</p>
                </div>
                ...
                <div class="space-y-4">
                    @foreach($recent_programs as $program)
                        <div class="bg-slate-50 p-4 rounded-xl border-l-4 border-blue-500">
                            ...
                            <p class="text-xs text-slate-500 mt-1">60% Selesai</p>
                        </div>
                    @endforeach
                </div>
            @else
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100">
            ...
            <div class="space-y-4">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        <p class="font-bold text-slate-800">Tugas Matematika dikumpulkan</p>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        <p class="font-bold text-slate-800">Nilai Fisika keluar: 85</p>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        <p class="font-bold text-slate-800">Pengumuman: Quiz besok jam 3 sore</p>
