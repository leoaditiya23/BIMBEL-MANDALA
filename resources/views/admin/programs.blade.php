                ...
                <div class="relative z-10 text-white">
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <button @click="
                            ...
                            editData.jenjang = '{{ $program->jenjang ?? 'SD' }}';
                            ...
                            editData.type = '{{ $program->type ?? 'reguler' }}';
                    ...
                    <div class="space-y-3.5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-white">
                                ...
                                <select name="type" required class="w-full px-3 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                        ...
                        <div class="bg-white">
                            <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1 px-1">Harga Dasar</label>
                            <input type="number" name="price" required class="w-full px-4 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-white">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1 px-1">Extra Sesi</label>
                                <input type="number" name="extra_meeting_price" value="0" required class="w-full px-4 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                            </div>
                            <div class="bg-white">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1 px-1">Harga Ngaji</label>
                                <input type="number" name="quran_price" value="0" required class="w-full px-4 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                            </div>
                        </div>
            ...
            <div x-show="showEditModal" class="relative bg-white w-full max-w-sm rounded-2xl p-6 shadow-2xl border-[4px] border-slate-50 overflow-y-auto max-h-[90vh]">
                ...
                <form :action="'{{ url('admin/programs-action/update') }}/' + editData.id" method="POST">
                    ...
                    <div class="space-y-3.5">
                        ...
                        <div class="bg-white">
                            <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1 px-1">Mentor Penanggung Jawab</label>
                            <select name="mentor_id" x-model="editData.mentor_id" required class="w-full px-3 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                                @foreach($mentors as $mentor)
                                    <option value="{{ $mentor->id }}">{{ $mentor->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-white">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1 px-1">Tipe</label>
                                <select name="type" x-model="editData.type" required class="w-full px-3 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                                    <option value="reguler">Reguler</option>
                                    <option value="intensif">Intensif</option>
                                </select>
                            </div>
                        ...
                        <div class="bg-white">
                            <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1 px-1">Harga Dasar</label>
                            <input type="number" name="price" x-model="editData.price" required class="w-full px-4 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            <div class="bg-white">
                                ...
                                <input type="number" name="extra_meeting_price" x-model="editData.extra_meeting_price" required class="w-full px-4 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                            </div>
                            <div class="bg-white">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1.5 px-1 text-nowrap">Harga Ngaji</label>
                                <input type="number" name="quran_price" x-model="editData.quran_price" required class="w-full px-4 py-2.5 rounded-lg bg-[#f8fafc] border-2 border-slate-100 outline-none font-bold text-slate-800 text-xs focus:border-blue-500 transition">
                            </div>
                        </div>
